...
const TasksPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const weeklyTasks: Task[] = [
      ...
      { id: 'mon-1', title: 'Welcome to EarnPro', description: 'Watch our introduction video', type: 'video', reward: 2.50, duration: 180, url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', requiredWatchPercentage: 80, isCompleted: false, isLocked: false, dayOfWeek: 1, order: 1 },
      ...
      { id: 'mon-3', title: 'Platform Overview', description: 'Learn about EarnPro features', type: 'video', reward: 3.00, duration: 240, url: 'https://www.youtube.com/watch?v=9bZkp7q19f0', requiredWatchPercentage: 80, isCompleted: false, isLocked: true, dayOfWeek: 1, order: 3 },
      ...
      { id: 'mon-5', title: 'Referral System Guide', description: 'Master the referral system', type: 'video', reward: 2.75, duration: 200, url: 'https://www.youtube.com/watch?v=jNQXAC9IVRw', requiredWatchPercentage: 80, isCompleted: false, isLocked: true, dayOfWeek: 1, order: 5 },
      ...
      { id: 'tue-1', title: 'Advanced Referrals', description: 'Multi-level referral strategies', type: 'video', reward: 3.50, duration: 280, url: 'https://www.youtube.com/watch?v=ScMzIvxBSi4', requiredWatchPercentage: 80, isCompleted: false, isLocked: false, dayOfWeek: 2, order: 1 },
      ...
      { id: 'tue-3', title: 'Social Media Marketing', description: 'Leverage social platforms', type: 'video', reward: 3.00, duration: 220, url: 'https://www.youtube.com/watch?v=L_LUpnjgPso', requiredWatchPercentage: 80, isCompleted: false, isLocked: true, dayOfWeek: 2, order: 3 },
